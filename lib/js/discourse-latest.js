(function ($) {
	$( document ).ready(
		function () {
			...
			verticalEllipsis = wpds.verticalEllipsis,
							...
							$.ajax(
								{
									...
									complete: function () {
										...
										$tiles.each(
											function () {
												// If verticalEllipsis option is enabled, truncate the text until it fits
												// in it's container. This only occurs when the topic has a set height.
												if ( verticalEllipsis ) {
                                                    var $this = $( this ),
